$(document).ready(function() {
    ...
    $(".iqac-menu").mouseleave(function() {
	 ...
	 //MEGA MENU 	
    $(".research-menu").hover(function() {
        $(".research-mm").fadeIn();
    });
    $(".research-menu").mouseleave(function() {
        $(".research-mm").fadeOut();
    });
	 //MEGA MENU	
    ...
    $(".library-menu").mouseleave(function() {
        $(".library-mm").fadeOut();
    });
	 //MEGA MENU	
    $(".feedback-menu").hover(function() {
        $(".feedback-mm").fadeIn();
    });
    $(".feedback-menu").mouseleave(function() {
        $(".feedback-mm").fadeOut();
    });
	 //MEGA MENU	
    $(".campuslife-menu").hover(function() {
        $(".campuslife-mm").fadeIn();
    });
    $(".campuslife-menu").mouseleave(function() {
        $(".campuslife-mm").fadeOut();
    });
    //MEGA MENU	
	...
	//MEGA MENU	
    $(".placements-menu").hover(function() {
        $(".placements-mm").fadeIn();
    });
    $(".placements-menu").mouseleave(function() {
        $(".placements-mm").fadeOut();
    });
