...
void ratio::display() /*member function definition outside
...
void ratio::value() /*member function definition outside
...
cin >> x;
ratio r2 = ratio(x); /*parameterised constructor gets
